...
export class TaskDetailsComponent {
  ...
  tasks: Task[]
  department: any;
  constructor(private router: Router,private _location: Location, private authsvc: AuthService, private svc: TaskService, private _Activatedroute: ActivatedRoute) {
    this.tasks = [];
  }
  ngOnInit(): void {
