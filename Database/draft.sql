...
create table
    workerstatus(
        ...
        constraint fk_workerid foreign key(workerid) references employees(id) on update cascade on delete cascade,
...
CREATE TABLE
    materials(
        ...
        constraint fk_category_id FOREIGN KEY(categoryid) REFERENCES categories(id) on UPDATE cascade on delete cascade,
...
create table
    Warehouse(
        ...
        section VARCHAR(20),
        categoryid int not null,
        constraint fk_category_id1 foreign key(categoryid) references categories(id) on update cascade on delete cascade,
        employeeid int not null,
        constraint fk_employeeid foreign key(employeeid) references employees(id) on update cascade on delete cascade
    );
...
CREATE TABLE
    orderdetails(
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
        employeeid INT NOT NULL,
        CONSTRAINT fk_employee_id FOREIGN KEY (employeeid) REFERENCES employees(id) ON UPDATE CASCADE ON DELETE CASCADE,
        materialid INT NOT NULL,
        CONSTRAINT fk_materialid FOREIGN KEY (materialid) REFERENCES materials(id) ON UPDATE CASCADE ON DELETE CASCADE,
        categoryid INT NOT NULL,
        constraint fk_categoryid FOREIGN KEY(categoryid) REFERENCES categories(id) on UPDATE cascade on delete cascade,
        requestid INT NOT NULL,
        constraint fk_reqid FOREIGN KEY(requestid) REFERENCES requests(id) on UPDATE cascade on delete cascade,
        quantity INT NOT NULL
    );
...
CREATE TABLE
    orders(
        ...
        CONSTRAINT fk_orderdetailsid FOREIGN KEY (orderdetailid) REFERENCES orderdetails(id) ON UPDATE CASCADE ON DELETE CASCADE,
        employeeid INT NOT NULL,
        CONSTRAINT fk_employees_id FOREIGN KEY (employeeid) REFERENCES employees(id) ON UPDATE CASCADE ON DELETE CASCADE,
        status ENUM(
            'delivered',
            'initiated',
            'inprogress',
...
CREATE TABLE
    cartitems(
        ...
        materialid INT NOT NULL,
        CONSTRAINT fk_material_id4 FOREIGN KEY (materialid) REFERENCES materials(id) ON UPDATE CASCADE ON DELETE CASCADE,
        categoryid INT NOT NULL,
        constraint fk_categoryid2 FOREIGN KEY(categoryid) REFERENCES categories(id) on UPDATE cascade on delete cascade,
        quantity INT NOT NULL
    );
...
CREATE TABLE
    shippingdetails(
        ...
        CONSTRAINT fk_employee_id7 FOREIGN KEY (supervisorid) REFERENCES employees(id) ON UPDATE CASCADE ON DELETE CASCADE,
        materialid INT NOT NULL,
        CONSTRAINT fk_materialid_4 FOREIGN KEY (materialid) REFERENCES materials(id) ON UPDATE CASCADE ON DELETE CASCADE,
        categoryid INT NOT NULL,
        constraint fk_categoryid_5 FOREIGN KEY(categoryid) REFERENCES categories(id) on UPDATE cascade on delete cascade,
        requestid INT NOT NULL,
        CONSTRAINT fk_request_id FOREIGN KEY (requestid) REFERENCES requests(id) ON UPDATE CASCADE ON DELETE CASCADE,
        quantity INT NOT NULL
    );
...
CREATE TABLE
    shipments(
        ...
        CONSTRAINT fk_shipmentdetails_id FOREIGN KEY (shippingdetailsid) REFERENCES shippingdetails(id) ON UPDATE CASCADE ON DELETE CASCADE,
        CONSTRAINT fk_employee_id6 FOREIGN KEY (storemanagerid) REFERENCES employees(id) ON UPDATE CASCADE ON DELETE CASCADE,
        shipperid INT NOT NULL,
        CONSTRAINT fk_shipperid FOREIGN KEY (shipperid) REFERENCES employees(id) ON UPDATE CASCADE ON DELETE CASCADE,
        status ENUM(
            'Pending',
            'Ready To Dispatch',
            'Picked',
